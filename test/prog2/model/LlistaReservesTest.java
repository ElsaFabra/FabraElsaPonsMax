...
public class LlistaReservesTest {
    ...
    private java.time.LocalDate dataSortida;
    ...
    public void setUp() {
        ...
        dataSortida = java.time.LocalDate.of(2026, 5, 20);
    }
    ...
    public void testAfegirReservaNoDisponible() throws ExcepcioReserva {
        ...
        java.time.LocalDate novaDataEntrada = java.time.LocalDate.of(2026, 5, 18);
        java.time.LocalDate novaDataSortida = java.time.LocalDate.of(2026, 5, 22);
    ...
    void testEstadaMinima() throws ExcepcioReserva {
        ...
        java.time.LocalDate dataEntrada = java.time.LocalDate.of(2026, 7, 1);

        // ---------
        // Estada massa curta → ha de fallar
        // ---------
        java.time.LocalDate dataSortidaCurta = java.time.LocalDate.of(2026, 7, 5); // 4 dies
        ...
        // ---------
        java.time.LocalDate dataSortidaLonga = java.time.LocalDate.of(2026, 7, 8); // 7 dies
